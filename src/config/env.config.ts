...
export class ConfigService {
  ...
  private loadEnv() {
    ...
    if (process.env?.DOCKER_ENV === 'true') {
      ...
      this.env.SERVER.PORT = Number.parseInt(process.env.SERVER_PORT) || 2202;
    }
  }
  ...
  private envProcess(): Env {
    return {
      SERVER: {
        ...
        PORT: Number.parseInt(process.env.SERVER_PORT) || 2202,
      ...
      DATABASE: {
        CONNECTION: {
          ...
          DB_PREFIX_NAME: process.env.DATABASE_CONNECTION_DB_PREFIX_NAME || 'tb_whatsapp_api',
        },
      ...
      CONFIG_SESSION_PHONE: {
        CLIENT: process.env?.CONFIG_SESSION_PHONE_CLIENT || 'Chrome (Linux)',
      ...
      AUTHENTICATION: {
        ...
        JWT: {
          EXPIRIN_IN: Number.isInteger(process.env?.AUTHENTICATION_JWT_EXPIRIN_IN)
            ...
            : 3600,
          SECRET: process.env.AUTHENTICATION_JWT_SECRET || '1cb6e#b276be8#80eb&l5',
        },
      },
    };
  }
